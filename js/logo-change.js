...
logoPride.src = rootPath + "vi-logo-big-pride.png";logoLesbian.src = rootPath + "vi-logo-big-lesbian.png";logoGay.src = rootPath + "vi-logo-big-gay.png";logoBi.src = rootPath + "vi-logo-big-bi.png";logoPan.src = rootPath + "vi-logo-big-pan.png";logoTrans.src = rootPath + "vi-logo-big-trans.png";logoEnby.src = rootPath + "vi-logo-big-nonbinary.png";logoAro.src = rootPath + "vi-logo-big-aro.png";logoAce.src = rootPath + "vi-logo-big-ace.png";
logoWh.src = rootPath + "vi-logo-big-wh.png";logoMagenta.src = rootPath + "vi-logo-big-atpm.png";logoHeart.src = rootPath + "vi-logo-big-heart.png";logoRomania.src = rootPath + "vi-logo-big-romania.png";
logoHangar.src = rootPath + "vi-logo-big-hngo.png";logoJailbird.src = rootPath + "vi-logo-big-jbdo.png";logoMountain.src = rootPath + "vi-logo-big-mntg.png";logoOdyssey.src = rootPath + "vi-logo-big-odr.png";logoVidal.src = rootPath + "vi-logo-big-vidy.png";
...
document.addEventListener('DOMContentLoaded', function() {var headerLogo = document.getElementById('logo');headerLogo.src = logoHeart.src;});
} else if (
currentDate >= startDate_AroAwarenessWeek && currentDate <= endDate_AroAwarenessWeek
) {
document.addEventListener('DOMContentLoaded', function() {var headerLogo = document.getElementById('logo');headerLogo.src = logoAro.src;});
} else if (
currentDate.getMonth() === date_TransVisibilityDay.getMonth() && currentDate.getDate() === date_TransVisibilityDay.getDate()
) {
document.addEventListener('DOMContentLoaded', function() {var headerLogo = document.getElementById('logo');headerLogo.src = logoTrans.src;});
} else if (
currentDate.getMonth() === date_AceDay.getMonth() && currentDate.getDate() === date_AceDay.getDate()
) {
document.addEventListener('DOMContentLoaded', function() {var headerLogo = document.getElementById('logo');headerLogo.src = logoAce.src;});
} else if (
currentDate.getMonth() === date_ATP.getMonth() && currentDate.getDate() === date_ATP.getDate()
) {
document.addEventListener('DOMContentLoaded', function() {var headerLogo = document.getElementById('logo');headerLogo.src = logoMagenta.src;});
} else if (
currentDate >= startDate_PanAwarenessDay && currentDate <= endDate_PanAwarenessDay
) {
document.addEventListener('DOMContentLoaded', function() {var headerLogo = document.getElementById('logo');headerLogo.src = logoPan.src;});
} else if (
currentDate >= startDate_PrideMonth && currentDate <= endDate_PrideMonth
) {
document.addEventListener('DOMContentLoaded', function() {var headerLogo = document.getElementById('logo');headerLogo.src = logoPride.src;});
} else if (
currentDate.getMonth() === date_EnbyDay && currentDate.getDate() === date_EnbyDay.getDate()
) {
document.addEventListener('DOMContentLoaded', function() {var headerLogo = document.getElementById('logo');headerLogo.src = logoEnby.src;});
} else if (
currentDate.getMonth() === date_BiDay && currentDate.getDate() === date_BiDay.getDate()
) {
document.addEventListener('DOMContentLoaded', function() {var headerLogo = document.getElementById('logo');headerLogo.src = logoBi.src;});
} else if (
...
document.addEventListener('DOMContentLoaded', function() {var headerLogo = document.getElementById('logo');headerLogo.src = logoRomania.src;});
} else {
document.addEventListener('DOMContentLoaded', function() {var headerLogo = document.getElementById('logo');headerLogo.src = logoWh.src;});
}
